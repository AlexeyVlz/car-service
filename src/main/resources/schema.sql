...
CREATE TABLE IF NOT EXISTS auto_parts (
    ...
    CONSTRAINT            fk_auto_parts_on_branches FOREIGN KEY (branch_id) REFERENCES branches(branch_id)
);
...
CREATE TABLE IF NOT EXISTS clients (
    ...
    CONSTRAINT     fk_clients_on_cars FOREIGN KEY (car_id) REFERENCES cars(car_id)
);
...
CREATE TABLE IF NOT EXISTS orders (
    ...
    CONSTRAINT   fk_orders_on_services FOREIGN KEY (service_id) REFERENCES services(service_id),
    CONSTRAINT   fk_orders_on_employees FOREIGN KEY (employee_id) REFERENCES employees(employee_id),
    CONSTRAINT   fk_orders_on_auto_parts FOREIGN KEY (auto_part_id) REFERENCES auto_parts(auto_part_id),
